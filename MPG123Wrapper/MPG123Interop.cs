...
namespace MPG123Wrapper
{
    public static class MPG123Interop
    {
        ...
        public const int MPG123_ENC_SIGNED_16 = 0xD0;
        public const int MPG123_ENC_FLOAT_32 = 0x200;

        [DllImport("libmpg123", CallingConvention = CallingConvention.Cdecl)]
        public static extern int mpg123_init();
        [DllImport("libmpg123", CallingConvention = CallingConvention.Cdecl)]
        public static extern void mpg123_exit();
        [DllImport("libmpg123", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
